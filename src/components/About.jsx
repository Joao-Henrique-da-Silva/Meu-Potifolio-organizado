    ...
    <section id="sobre" className="py-16">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-10 items-center">
          <div className="bg-linear-to-br from-primary to-secondary rounded-2xl p-8 text-white text-center shadow-xl min-h-50 flex flex-col justify-center">
          ...
          <div className="md:col-span-2 space-y-4 text-card-text">
            <p>
            ...
            <p>
              Atualmente em transição para a área de tecnologia, com foco em <strong className="text-primary">desenvolvimento full stack</strong>. 
              Cursando <strong className="text-primary">Engenharia da Computação</strong> (UNIVESP) e formação complementar no curso <strong className="text-primary">DEVquest 2.0</strong>.
            </p>
            <p>
